...
<div class="dashboard-flex">
    ...
    <div class="container">
        <div class="page-title">
            <h1>Buy Premium Gold</h1>
            <p>Purchase gold with your available coins</p>
        </div>
            ...
            <div class="card-content">
                <div class="grid grid-cols-4">
                    ...
                    <div class="info-card">
                        ...
                        <div class="label">Gold Wallet</div>
        ...
        <div class="card">
            ...
            <div class="card-content space-y-6">
                ...
                <div class="space-y-4">
                    <div>
                        <label for="gold-amount" class="label">Gold Amount to Purchase (Troy Ounces)</label>
                ...
                <div class="receipt p-6">
                    <div class="receipt-header">
                        <h3 class="text-lg font-semibold text-gold mb-1">Buy Receipt</h3>
    ...
    <script>
        ...
        var base_buy_price= 0;
        var goldPrice = 0;
        const dailyLimit = 10;
        var dailyBuy = 0;
        var remainingDailyLimit = dailyLimit - dailyBuy;
        var maxBuyableGold =  remainingDailyLimit;
		function refreshAllData() {
        	...
        	xhttp.onreadystatechange = function() {
            	if (this.readyState == 4 && this.status == 200) {
                    ...
                    base_buy_price = parseFloat(data.base_sell_price/1000);
                    goldPrice = base_buy_price+(base_buy_price*0.01);
                    ...
                    dailyBuy = data.buy_gold_amount;
                    remainingDailyLimit = dailyLimit - dailyBuy;
                    maxBuyableGold = remainingDailyLimit;
    ...
    <script>
        ...
        function initialize() {
            updateReceipt();
            updateSellButton();
            goldSlider.max = maxBuyableGold.toFixed(2);
            maxDisplaySpan.textContent = `${maxBuyableGold.toFixed(2)} kt`;
        }
        ...
        function updateSellButton() {
            ...
            }else if(userDollarBalance<(goldAmount*goldPrice)){
                sellBtn.textContent="insufficient coin balance";
                sellBtn.disabled = true;
            }else{
                sellBtn.disabled = false;
                sellBtn.textContent= `Buy ${goldAmount.toFixed(2)} kt Gold`;
            }
        }
        ...
        function handleGoldAmountChange(value) {
            ...
            if (!isNaN(amount) && amount >= 0) {
                goldAmount = Math.min(amount, maxBuyableGold);
        ...
        // Handle sale
        function handleSale() {
			if(userDollarBalance<(goldAmount * goldPrice)){
				alert('error');
			}else{
				var userData = {
					amount : goldAmount,
				...
				alert('purchase gold request is successfully sent');
            	goldAmount = 0.1;
            	goldAmountInput.value = goldAmount;
            	goldSlider.value = goldAmount;
            	initialize();
