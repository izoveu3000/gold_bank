 ...
 <div class="dashboard-flex">
  ...
  <header class="top-header">
    <div class="top-header-content">
      <div>
        ...
        <h1>Withdraw Capital & Sell Gold</h1>
  ...
  <main class="full-bleed">
    ...
    <section class="left-section">
      ...
      <!-- Tabs -->
      <div class="tab-bar">
        <button id="usdTab" class="tab active">Withdraw Capital</button>
        <button id="goldTab" class="tab">Sell Gold</button>
      </div>
      ...
      <div id="usdPanel" class="panel">
        ...
        <label for="usdAmount">Capital Amount To Withdraw</label>
      ...
      <div id="goldPanel" class="panel hidden">
        ...
        <input id="goldAmount" type="number" placeholder="Enter gold amount in kyatar" />
  ...
  <script>
    ...
    document.getElementById('usdAmount').addEventListener('input', e => {
      ...
      if(val<0){
        ...
        `Withdraw ${val} Coins (${(val*1000).toLocaleString()} MMK)`;
        usdAmount=val;
    ...
    document.getElementById('goldAmount').addEventListener('input', e => {
      ...
      if(val<0){
        ...
        `Sell ${val} oz Gold ($${(val*gold_price).toLocaleString()})`;
        goldAmount=val;
    ...
    function refreshAllData() {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                document.getElementById('gold_price').innerHTML= Number(data.base_sell_price).toLocaleString()+" Coins/kyatar";
                document.getElementById('gold_price_mmk').innerHTML= Number(data.base_sell_price*1000).toLocaleString()+" MMK";

                
                gold_price =data.base_sell_price;
